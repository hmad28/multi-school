...
const props = defineProps<{ violations: any; students: any[]; filters: { status?: string; student_id?: string }; thresholds: Array<{ points: number; label: string }> }>();
