...
const props = defineProps<{ points: Paginated<any>; students: Student[]; filters: { student_id?: string; category?: string }; categories: string[]; totals: Record<string, number>; canInput: boolean; canManageTypes: boolean }>();
