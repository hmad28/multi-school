...
const form = useForm({ date: '', name: '', description: '', status: 'active' });
    ...
    <AuthenticatedLayout>
        <template #header>
            <div>
                ...
                <h1 class="text-2xl font-bold text-ink dark:text-white">Tambah hari libur</h1>
                <p class="text-sm text-slate-500">Tanggal ini hanya berlaku untuk tenant aktif.</p>
            </div>
        </template>
        ...
        <form class="app-card max-w-2xl space-y-4 p-5" @submit.prevent="submit">
            ...
            <div class="flex flex-wrap gap-2 pt-2">
                <button type="submit" class="app-button-primary" :disabled="form.processing">Simpan</button>
